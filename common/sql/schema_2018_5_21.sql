...
create table if not exists developers(
  ...
  d_name varchar(32) not null collate utf8_general_ci,
  d_company varchar(64) collate utf8_general_ci,
  d_email VARCHAR(64) collate utf8_general_ci,
  d_phone VARCHAR (64) collate utf8_general_ci,
  d_pwd VARCHAR (64)  not null collate utf8_general_ci,
  d_token VARCHAR (64) not null collate utf8_general_ci,
...
create table if not exists developer_verify(
  ...
  d_email VARCHAR(64) collate utf8_general_ci,
  d_phone VARCHAR (64) collate utf8_general_ci,
  d_email_code VARCHAR(6) collate utf8_general_ci,
  d_phone_code VARCHAR(6) collate utf8_general_ci,
...
create table if not exists developer_adds(
  id int(32) not null PRIMARY KEY key auto_increment,
  d_id int(32) not null,
  d_profession varchar(64) not null collate utf8_general_ci COMMENT '行业',
  d_bussiness VARCHAR(64) not null collate utf8_general_ci COMMENT '主营业务',
  d_website VARCHAR (64) not null collate utf8_general_ci,
  d_country VARCHAR (64) not null collate utf8_general_ci,
  d_address VARCHAR (64) not null collate utf8_general_ci,
  d_street VARCHAR (64) not null collate utf8_general_ci,
  d_tel VARCHAR (64) not null collate utf8_general_ci,
  d_fax VARCHAR (64) not null collate utf8_general_ci,
...
create table if not exists developer_real(
  id int(32) not null PRIMARY KEY key auto_increment,
  d_id int(32) not null,
  d_realname VARCHAR(64) NOT NULL collate utf8_general_ci,
  d_id_real VARCHAR(64) NOT NULL collate utf8_general_ci,
...
create table if not exists apps(
    ...
    a_type VARCHAR(64) NOT NULL collate utf8_general_ci,
    a_tech VARCHAR(32) not NULL collate utf8_general_ci,
    a_trans TINYINT DEFAULT 1 COMMENT '0定长，1变长',
    a_company VARCHAR(64) NOT NULL collate utf8_general_ci,
    a_product_key VARCHAR(64) NOT NULL collate utf8_general_ci,
    a_product_secret VARCHAR(64) not null collate utf8_general_ci,
...
CREATE TABLE  if NOT EXISTS datapoint(
  ...
  p_name VARCHAR(64) NOT NULL collate utf8_general_ci,
  p_type VARCHAR(32) NOT NULL collate utf8_general_ci,
...
create table if not exists developer_1_client(
  id int(32) PRIMARY KEY NOT NULL AUTO_INCREMENT,
  a_id int(32) NOT NULL,
  client_id varchar(64) not null collate utf8_general_ci,
...
CREATE  TABLE if NOT EXISTS ${name} (
  ...
  a_id int(32) NOT NULL ,
  m_from VARCHAR (64) NOT NULL collate utf8_general_ci,
  m_to VARCHAR (64) NOT NULL collate utf8_general_ci,
  m_qos VARCHAR (64) NOT NULL collate utf8_general_ci,
  m_message text NOT NULL collate utf8_general_ci,
...
CREATE table if not exists img(
  id int(32) PRIMARY KEY NOT NULL AUTO_INCREMENT,
  i_hash_code VARCHAR(64) NOT NULL collate utf8_general_ci,
  i_file_name varchar(64) not null collate utf8_general_ci,
  i_file_path VARCHAR(64) not null collate utf8_general_ci,
  i_file_size bigint,
  i_file_type VARCHAR(32) collate utf8_general_ci,
...
id int(32) NOT NULL  PRIMARY KEY AUTO_INCREMENT,
opeator VARCHAR(64) not null collate utf8_general_ci comment '表达式',
create_time DATETIME DEFAULT current_timestamp
)Engine = InnoDB;
...
right_value VARCHAR(64) collate utf8_general_ci comment '表达式右值',
create_time DATETIME DEFAULT current_timestamp
)Engine = InnoDB;
...
CREATE  TABLE  if NOT EXISTS sys_log(
 ...
 l_s_content VARCHAR(256) COLLATE utf8_general_ci,
...
create table if not exists account(
  ...
  a_name varchar(64) COLLATE utf8_general_ci,
  a_email VARCHAR(64) COLLATE utf8_general_ci,
  a_phone int(15),
  a_company VARCHAR(64) COLLATE utf8_general_ci,
  a_label VARCHAR(64) COLLATE utf8_general_ci,
  a_address VARCHAR(64) COLLATE utf8_general_ci,
  a_logo VARCHAR(64) COLLATE utf8_general_ci
)Engine = InnoDB;
...
create table if not exists monitor_${appID}_relation(
    ...
    c_id varchar(64) not null COLLATE utf8_general_ci comment '设备clientID',
...
create table if not exists mapper(
  ...
  b_type VARCHAR(32) NOT NULL COLLATE utf8_general_ci COMMENT  '智能模组型号',
  m_create_time DATETIME DEFAULT current_timestamp
);
...
create table if not EXISTS  access(
  ...
  name VARCHAR (32) NOT NULL COLLATE utf8_general_ci,# 权限名称
  action VARCHAR(128) not null COLLATE utf8_general_ci, # 权限可访问动作:方法
  create_time DATETIME DEFAULT current_timestamp
)Engine = InnoDB;
...
create table if not EXISTS  wo(
  ...
  title VARCHAR (128) NOT NULL COLLATE utf8_general_ci,# 标题
  level int(32) not null DEFAULT 0,#紧急程度
  level_content VARCHAR(64) COLLATE utf8_general_ci,#紧急描述
  content VARCHAR (256) COLLATE utf8_general_ci,# 问题描述
  attach VARCHAR (128) COLLATE utf8_general_ci,# 附件
  contact VARCHAR (64) not null COLLATE utf8_general_ci,# 联系方式
...
create table if not exists article(
  ...
  tags_id       VARCHAR(64) COLLATE utf8_general_ci,
  can_comment   tinyint DEFAULT 1,
  abstract      VARCHAR(256) COLLATE utf8_general_ci,
  type tinyint  DEFAULT 0,
  start_count   int(32) NOT NULL DEFAULT 1,
  from_where    VARCHAR(32) COLLATE utf8_general_ci,
  from_url      VARCHAR(128) COLLATE utf8_general_ci,
...
create table if not exists author(
  id              int(32) PRIMARY KEY auto_increment,
  nickname        VARCHAR(32) NOT NULL COLLATE utf8_general_ci,
...
alter table author add sid int(32) NOT NULL;
...
create table if not exists activity(
  ...
  persons VARCHAR(128) NOT NULL COLLATE utf8_general_ci,
...
create table if not exists entry(
  ...
  name VARCHAR(32) NOT NULL COLLATE utf8_general_ci,
  name_url VARCHAR(32) NOT NULL COLLATE utf8_general_ci,
