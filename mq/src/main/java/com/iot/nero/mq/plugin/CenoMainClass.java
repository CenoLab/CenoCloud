...
package com.iot.nero.mq.plugin;

import com.iot.nero.mq.callbacks.*;
import com.iot.nero.mq.callbacks.advanced.*;
 ...
 */
public class CenoMainClass extends PluginEntryPoint {

    Logger log = LoggerFactory.getLogger(CenoMainClass.class);
    ...
    @Inject
    public CenoMainClass(final RetainedMessageStore retainedMessageStore,
    ...
    public void postConstruct() {
        ...
        callbackRegistry.addCallback(userAuthentication);
