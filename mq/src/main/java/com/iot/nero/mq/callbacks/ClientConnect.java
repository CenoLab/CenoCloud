...
public class ClientConnect implements OnConnectCallback {
    ...
    public void onConnect(CONNECT connect, ClientData clientData) throws RefusedConnectionException {
        ...
        String appKey  = connect.getUsername();
        String clientID  = clientData.getClientId();

//        String shouldTopic = "/"+appKey+"/"+clientID;
//
//        if(!shouldTopic.equals(connect.getWillTopic())){
//            throw new RefusedConnectionException("非法topic:[ "+connect.getWillTopic()+" ]订阅",REFUSED_IDENTIFIER_REJECTED);
//            //非法topic 订阅，拒绝，强制掉线
//        }else{
//            //发送数据协议
//        }
